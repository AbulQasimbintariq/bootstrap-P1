...
- If you add icons that rely on an external icon sprite or library, include that resource (e.g., Bootstrap Icons) or inline the SVG symbols.
    ...
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
      <div class="container-fluid bg-light">
        <a class="navbar-brand" href="home.html">AIcode</a>
        <button
        ...
        <div class="collapse navbar-collapse" id="navbarScroll">
          ...
          >
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="#">Fake ID_Detector</a></li>
                <li>
                  <a class="dropdown-item" href="#">Invetory Organizer</a>
                </li>
                <li><hr class="dropdown-divider" /></li>
                <li>
                  <a class="dropdown-item" href="#">Note Identifier</a>
                </li>
                <li>
                  <a class="dropdown-item" href="Navbar/album.html">Album</a>
                </li>
              </ul>
            </li>
          </ul>
          <form class="d-flex" role="search">
            <input
              class="form-control me-2 bg-info"
              type="search"
              placeholder="Search "
              aria-label="Search"
            />
    ...
    <div id="carouselExampleDark" class="carousel carousel-dark slide">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active" data-bs-interval="10000">
          <img
            src="https://plus.unsplash.com/premium_photo-1725985758331-e1b46919d8cf?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8QUklMjBBZ2VudHN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&q=60&w=600&h=200"
            class="d-block w-100"
            alt="HeroSections Pic"
          />
        ...
        <div class="carousel-item" data-bs-interval="2000">
          <img
            src="https://plus.unsplash.com/premium_photo-1726079246917-46f2b37f7e9e?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OXx8QUklMjBBZ2VudHN8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&q=60&w=600&h=200"
            class="d-block w-100"
            alt="HeroSections Pic"
          />
          <div class="carousel-caption d-none d-md-block">
        ...
        <div class="carousel-item">
          <img
            src="https://plus.unsplash.com/premium_photo-1725985758385-d5462d6e7f50?ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTl8fEFJJTIwQWdlbnRzfGVufDB8fDB8fHww&auto=format&fit=crop&q=60&w=600&h=200"
            class="d-block w-100"
            alt="HeroSections Pic"
          />
          <div class="carousel-caption d-none d-md-block">
